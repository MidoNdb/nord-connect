...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950">
      ...
      >
        {/* Top Bar */}
        <header className="bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-slate-800 sticky top-0 z-30 backdrop-blur-sm bg-white/95 dark:bg-slate-900/95">
          <div className="px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              {/* Spacer pour le bouton mobile (évite chevauchement) */}
