...
export default function Sidebar({ activeFeature, setActiveFeature, isCollapsed, setIsCollapsed }) {
  ...
  // Ferme le menu mobile sur échap
  useEffect(() => {
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-3 bg-white dark:bg-slate-900 rounded-xl shadow-lg border border-gray-200 dark:border-slate-800 hover:bg-gray-50 dark:hover:bg-slate-800 transition-all"
      ...
      >
        ...
        <div className="h-full flex flex-col overflow-y-auto">
          {/* Header avec Logo */}
          <div className="flex-shrink-0 p-4 lg:p-6 border-b border-gray-200 dark:border-slate-800">
            <div className="flex items-center justify-between">
              {/* Logo + Titre */}
              {!isCollapsed ? (
                <div className="flex items-center gap-3 min-w-0">
                  <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 flex items-center justify-center shadow-lg">
                ...
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 flex items-center justify-center shadow-lg mx-auto">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                  </svg>
                </div>
              ...
              {!isCollapsed && (
                <button
                  ...
                  className="hidden lg:flex flex-shrink-0 p-2 hover:bg-gray-100 dark:hover:bg-slate-800 rounded-lg transition-all group"
                  title="Réduire le menu"
                  aria-label="Réduire le menu"
                >
                  <svg className="w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 19l-7-7 7-7m8 14l-7-7 7-7" />
                  </svg>
                </button>
              )}
              
              {/* Bouton Expand - Desktop uniquement */}
              {isCollapsed && (
                <button
                  onClick={() => setIsCollapsed(false)}
                  className="hidden lg:flex p-2 hover:bg-gray-100 dark:hover:bg-slate-800 rounded-lg transition-all mx-auto group"
              ...
              {/* Bouton Close - Mobile uniquement */}
              <button
                onClick={() => setIsMobileMenuOpen(false)}
                className="lg:hidden flex-shrink-0 p-2 hover:bg-gray-100 dark:hover:bg-slate-800 rounded-lg transition-all"
          ...
          <nav className="flex-1 p-3 lg:p-4 space-y-1 overflow-y-auto">
            ...
            {isCollapsed && (
              <div className="my-3 mx-3 h-px bg-gray-200 dark:bg-slate-800"></div>
            )}
            ...
            {/* Divider */}
            <div className={`${isCollapsed ? 'my-3 mx-3' : 'my-4 mx-3'} h-px bg-gray-200 dark:bg-slate-800`}></div>
          ...
          {/* Footer Utilisateur */}
          <div className="flex-shrink-0 p-3 lg:p-4 border-t border-gray-200 dark:border-slate-800">
            {!isCollapsed ? (
              <div className="bg-gray-50 dark:bg-slate-800 rounded-xl p-3 border border-gray-200 dark:border-slate-700 hover:border-blue-300 dark:hover:border-blue-600 hover:bg-gray-100 dark:hover:bg-slate-750 transition-all cursor-pointer group">
                <div className="flex items-center gap-3">
                  <div className="relative flex-shrink-0">
                    ...
                    <div className="absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-green-500 border-2 border-white dark:border-slate-800 rounded-full ring-1 ring-green-400"></div>
                  </div>
              ...
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold text-sm shadow-md mx-auto cursor-pointer hover:scale-110 hover:shadow-lg transition-all relative group">
                M
                <div className="absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-green-500 border-2 border-white dark:border-slate-900 rounded-full ring-1 ring-green-400"></div>
  ...
  return (
    <button
      ...
      className={`
        ...
        ${special && !active ? 'border-2 border-dashed border-gray-300 dark:border-slate-700 hover:border-blue-400 dark:hover:border-blue-600' : ''}
    ...
    >
      ...
      {/* Tooltip collapsed */}
      {isCollapsed && (
        <div className="absolute left-full ml-6 px-3 py-2 bg-gray-900 dark:bg-slate-800 text-white text-sm rounded-lg opacity-0 pointer-events-none group-hover:opacity-100 transition-opacity whitespace-nowrap z-50 shadow-xl">
          {label}
          {badge && (
          ...
          <div className="absolute right-full top-1/2 -translate-y-1/2 border-8 border-transparent border-r-gray-900 dark:border-r-slate-800"></div>
        </div>
      )}
    </button>
  );
